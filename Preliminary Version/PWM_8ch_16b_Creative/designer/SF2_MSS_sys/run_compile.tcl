...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\Hiperwall\Desktop\NewProject\PWM_8ch_16b_Creative\synthesis\SF2_MSS_sys.edn"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\Hiperwall\Desktop\NewProject\PWM_8ch_16b_Creative\designer\SF2_MSS_sys} \
    -design SF2_MSS_sys \
    -fam SmartFusion2 \
    -die PA4M2500_N \
    -pkg vf256 \
